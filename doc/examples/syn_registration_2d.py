...
"""
.. figure:: intermediate_images.png
   :align: center

   Static image deformed under the (inverse) static-to-reference transform in
   red on top of the moving image deformed under the (inverse)
   moving-to-reference transform.
"""
